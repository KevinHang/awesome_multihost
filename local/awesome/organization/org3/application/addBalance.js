...
async function main() {
    ...
    try {
        ...
        // Submit addBalance transaction
        console.log('Submit addBalance transaction.');
        const issueResponse = await contract.submitTransaction('addBalance', 150); // add 150 to balance

        // process response
        // console.log('Process addBalance transaction response.');
        // let result = JSON.parse(issueResponse.toString());
        // console.log(result);
        console.log('Transaction complete. Successfully added to balance.');
...
main().then(() => {
    console.log('Adding balance program complete.');
}).catch((e) => {
    console.log('Adding balance program exception.');
    console.log(e);
    console.log(e.stack);
    process.exit(-1);
});
