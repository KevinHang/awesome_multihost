...
async function main() {
    ...
    try {
        ...
        // Register a provider
        console.log('Submit deleteProvider transaction.');
        const issueResponse = await contract.submitTransaction('deleteProvider');

        // process response
        console.log('Process deleteProvider transaction response.');
        let result = issueResponse.toString();
        console.log(result);
        console.log('Transaction complete. Successfully deleted provider.');
...
main().then(() => {
    console.log('Delete provider program complete.');
}).catch((e) => {
    console.log('Delete provider program exception.');
    console.log(e);
    console.log(e.stack);
    process.exit(-1);
});
